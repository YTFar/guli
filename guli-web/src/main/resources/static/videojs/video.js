...
var BACKGROUND_SIZE_SUPPORTED = isReal() && 'backgroundSize' in window_1.document.createElement('templates.showWeb.course.video').style;
...
var autoSetup = function autoSetup() {
  ...
  var vids = document_1.getElementsByTagName('templates.showWeb.course.video');
...
Tech.withSourceHandlers = function (_Tech) {
  ...
  _Tech.prototype.disposeSourceHandler = function () {
    ...
    if (this.currentSource_) {
      this.clearTracks(['audio', 'templates.showWeb.course.video']);
  ...
  Html5.prototype.createEl = function createEl$$1() {
    ...
    if (!el || !(this.options_.playerElIngest || this.movingMediaElementInDOM)) {
      ...
      if (el) {
        ...
        el = document_1.createElement('templates.showWeb.course.video');
...
if (isReal()) {
   ...
   * @private
   */
  Html5.TEST_VID = document_1.createElement('templates.showWeb.course.video');
...
var Player = function (_Component) {
  ...
  Player.prototype.createEl = function createEl$$1() {
    ...
    if (divEmbed) {
      el = this.el_ = tag;
      tag = this.tag = document_1.createElement('templates.showWeb.course.video');
...
if (typeof HTMLVideoElement === 'undefined' && isReal()) {
  document_1.createElement('templates.showWeb.course.video');
