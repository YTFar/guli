...
import com.guli.media.MediaFileProcess_m3u8;
import com.guli.utils.HlsVideoUtil;
...
public class MediaProcessTask {
    ...
    //接收视频处理消息进行视频处理
    @RabbitListener(queues="${xc-service-manage-media.mq.queue-media-video-processtask}")
